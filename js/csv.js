...
const Csv = (() => {
  ...
  const FIELDS = [
    { id: 'key',        label: 'Номер',              required: true,
      synonyms: ['issue key', 'key', 'ключ задачи', 'ключ'] },
    ...
    { id: 'created',    label: 'Дата создания',      required: true,
      synonyms: ['created', 'создано', 'дата создания'] },
    ...
    { id: 'fixed',      label: 'Дата исправления',   hint: 'блокер снят у клиента',
      synonyms: ['дата исправления', 'fix date', 'fixed date', 'дата фикса', 'дата устранения'] },
    { id: 'resolved',   label: 'Дата закрытия',
      synonyms: ['resolved', 'дата решения', 'дата закрытия', 'resolution date'] },
